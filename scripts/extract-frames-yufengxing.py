#!/usr/bin/env python3
"""为逐玉全部 40 集抽取关键帧：每集 hero.jpg + 每场景 s{N}.jpg"""
import json, glob, os, subprocess

CONTENT_DIR = '/Users/chenzhiheng/Projects/drama-analysis/content/yufengxing'
VIDEO_DIR = '/Users/chenzhiheng/Projects/drama-analysis/与凤行'
...
for f in files:
    ...
    print(f'E{ep} ({slug}):')
    # hero: 用第一个场景的中点前 30s 或 40s 固定值，避开片头水印
    hero_ts = 40
